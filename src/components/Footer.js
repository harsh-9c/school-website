  ...
  return (
    <>
      <footer class=" text-center  footer-32892 expand-lg">
            ...
            <div class="row mt-3">
              <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 text-white">
                <h6 class="text-uppercase fw-bold mb-4">
                  <i class="fas fa-graduation-cap me-3"></i>Blue Swan Public
                  School
                </h6>
              ...
              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 text-white">
                ...
                <p>
                  <i class="fas fa-home me-3"></i> At- Hutupara,
                  Darlipali,Sundargarh,Odisha - 770072
                </p>
                <p>
        ...
        <div class="text-start p-3 watermark bg-grey text-white">
          <p>
            © Blue Swan Public School 2021. <br></br>All Rights Reserved
            Designed & Maintened by{" "}
